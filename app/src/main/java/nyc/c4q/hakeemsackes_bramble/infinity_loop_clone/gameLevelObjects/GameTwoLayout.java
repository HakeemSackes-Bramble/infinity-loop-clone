...
public class GameTwoLayout {
    ...
    public GameTwoLayout(SharedPreferences sharedPreferences, SharedPreferences.Editor editor) {
    ...
    public void createGameTiles() {
        for (int i = 0; i < rows * columns; i++) {
            ...
            Tile tile = new Tile(i, rand.nextInt(4), tileType, correctOrientation, Objects.requireNonNull(tilePossibilities.get(tileType)));
